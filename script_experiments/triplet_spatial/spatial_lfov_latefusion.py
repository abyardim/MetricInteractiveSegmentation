...
parser.add_argument('--inttest', type=int, help='Test interval', default=5)
...
d = torch.load("/srv/glusterfs/yardima/runs/deeplabv2/lfov/run_5/models/class-vgg-pascal_epoch-29.pth", map_location=lambda storage, loc: storage)
del d['fc8.bias']
del d['fc8.weight']
