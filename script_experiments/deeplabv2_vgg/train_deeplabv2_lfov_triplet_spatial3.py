...
save_dir_root = "/srv/glusterfs/yardima/runs/deeplabv2/lfov-triplet-spatial/"
modelName = 'class-vgg-pascal-spatial'
run_id = 3 
exp_name = 'pascal-deeplabv2-lfov-45dim-spatial-random'
...
net = deeptriplet.models.DeepLab_VGG_Spatial(n_classes=p['dim'])
...
loss_fn = deeptriplet.triplet.RandomTripletPreselected(n_batch=10, n_triplets=1000)
loss_fn_val = deeptriplet.triplet.RandomTripletPreselected(n_batch=1, n_triplets=500)
