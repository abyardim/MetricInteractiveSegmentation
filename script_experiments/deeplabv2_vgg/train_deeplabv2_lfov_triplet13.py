...
loss_fn = deeptriplet.triplet.RandomTripletPreselected(n_batch=10, n_triplets=p['ntriplets'])
loss_fn_val = deeptriplet.triplet.RandomTripletPreselected(n_batch=1, n_triplets=600)
