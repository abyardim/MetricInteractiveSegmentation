...
save_dir_root = "/srv/glusterfs/yardima/runs/deeplabv2/asppl-triplet/"
modelName = 'class-vgg-pascal'
run_id = 1 
exp_name = 'pascal-deeplabv2-asppl-45dim-random-triplet'
...
net = deeptriplet.models.DeepLab_VGG(n_classes=p['dim'], version="aspp-l")
...
loss_fn = deeptriplet.triplet.RandomTripletPreselected(n_batch=10, n_triplets=p['n_triplets'])
