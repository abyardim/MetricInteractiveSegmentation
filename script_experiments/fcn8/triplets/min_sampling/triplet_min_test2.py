...
save_dir_root = "/srv/glusterfs/yardima/runs/fcn8_embedding_min"
exp_name = 'fcn8-embedding-voc-min-1'
...
modelName = 'embedding-fcn8-voc12-min3890852'

triplet_fun = deeptriplet.triplet.RandomMinimumTriplet()
