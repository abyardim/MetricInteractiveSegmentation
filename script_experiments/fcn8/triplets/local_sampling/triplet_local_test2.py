...
snapshot = 6  # Store a model every snapshot epochs
...
save_dir_root = "/srv/glusterfs/yardima/runs/fcn8_embedding_local"
exp_name = 'fcn8-embedding-voc-loc-1'
...
modelName = 'embedding-fcn8-voc12-loc3890852'

triplet_fun = deeptriplet.triplet.LocalTriplet(n_triplets=200, sigma_pos=80, sigma_neg=20, margin=1, l2_penalty=1e-3, max_size=1599)
